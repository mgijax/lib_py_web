...
class SharedComponents:
	...
	def get (self,
		...
		if self.nameToComponent.has_key(nameOrAlias):
		...
		if self.aliasToName.has_key(nameOrAlias):
	...
	def getNames (self):
		...
		return self.nameToComponent.keys()
